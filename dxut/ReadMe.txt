Modified version of Microsoft DXUT. The unmodified version can be found on GitHub - https://github.com/Microsoft/DXUT

DXUT is distributed under the terms of the MIT License. See MIT.txt.
